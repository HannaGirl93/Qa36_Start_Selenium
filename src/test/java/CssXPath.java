...
public class CssXPath {
    ...
    public void fromCssToXpath (){
        ...
        wd.findElement(By.xpath("//a[@href]"));//@ по атрибуту

        wd.findElement(By.cssSelector("[href ^='/ho']"));
        wd.findElement(By.xpath("//*[starts-with(@href, 'ho')]"));//* если нет названия,starts-with с чего начинается + функция

        wd.findElement(By.cssSelector("div.focus"));
        wd.findElement(By.xpath("//div[@class='focus']"));//@class='' по классу

        wd.findElement(By.cssSelector("input[type='text']"));
        wd.findElement(By.xpath("//input[@type='text']"));//по значению
        ...
        wd.findElement(By.xpath("//div[@class='sort']/div[2]"));//спустится ниже - один слеж. второй ребенок [2]
